...
class TestRuleBasedAgent(unittest.TestCase):
    ...
    def test_rule_based_agent_block_horizontal(self):
    ...
    def test_rule_based_agent_block_vertical(self):
    ...
    def test_rule_based_agent_block_positive_diagonal(self):
    ...
    def test_rule_based_agent_block_negative_diagonal(self):
    ...
    def test_rule_based_agent_block_edge(self):
        """测试边缘情况：只有一端可堵时"""
        self.env.reset()
    ...
    def test_rule_based_agent_extend(self):
        """测试贪心智能体是否优先延续自己的棋子"""
        self.env.reset()
    ...
    def test_no_move_when_board_full(self):
        ...
        self.env.board[self.env.board!=1] = 1
